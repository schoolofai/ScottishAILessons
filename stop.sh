...
if [ -f "$SCRIPT_DIR/logs/backend.log" ] || [ -f "$SCRIPT_DIR/logs/context-chat.log" ] || [ -f "$SCRIPT_DIR/logs/frontend.log" ]; then
    ...
    [ -f "$SCRIPT_DIR/logs/backend.log" ] && echo -e "${BLUE}  📄 logs/backend.log${NC}"
    [ -f "$SCRIPT_DIR/logs/context-chat.log" ] && echo -e "${BLUE}  📄 logs/context-chat.log${NC}"
    [ -f "$SCRIPT_DIR/logs/frontend.log" ] && echo -e "${BLUE}  📄 logs/frontend.log${NC}"
    echo ""
    echo -e "${YELLOW}To clean up logs, run: rm -f logs/*.log${NC}"
fi